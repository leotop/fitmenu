...
<?
    if (!empty($minPrice))
    {
        if ('N' == $arParams['PRODUCT_DISPLAY_MODE'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
        {
            ...
            <p class="old"><?=CurrencyFormat($minPrice['VALUE'],  'RUR');?></p>
            <p class="product-price shk-price"><?=CurrencyFormat($minPrice['DISCOUNT_VALUE'], 'RUR');?></p>
            <?else:?>
            <p class="product-price shk-price"><?=CurrencyFormat($minPrice['VALUE'],  'RUR');?></p>
            <?endif;
        }
        else
        {
