<?
    ...
    $MESS['PH_REQUIRED'] = "обязательное поле";
    $MESS['CHOOSE_DELIVERY'] = "Выберите способ получения заказа:";
    $MESS['DELIVERY_1'] = "Доставка";
    $MESS['DELIVERY_2'] = "Самовывоз";
    $MESS['PAY_SYSTEM'] = "Выберите способ оплаты:";
    $MESS['SUM_PAY_SYSTEM'] = "Всего к оплате:";
    $MESS['SUM_SALE_PRODUCTS'] = "Товары в Вашей корзине:";
    $MESS['COMMENT_PLACE'] = "Введите текст";
    $MESS['DELIVERY_TITLE'] = "Введите район доставки:";
    $MESS['PICKUP_TITLE'] = "Выберите магазин для самовывоза:";
    $MESS['CITY_PROP'] = "Город";
    $MESS['STREET_PROP'] = "Улица";
    $MESS['HOUSE_PROP'] = "Дом";
    $MESS['CORP_PROP'] = "Корпус";
    $MESS['FLOOR_PROP'] = "Этаж";
    $MESS['FLAT_PROP'] = "Кв.";
    $MESS['ZIP_PROP'] = "Индекс";
    ...
    $MESS['SOA_TEMPL_ORDER_SUC_TD'] = "<b>№#ORDER_ID#</b> от #ORDER_DATE#";
    $MESS['SOA_TEMPL_ORDER_SUSESS'] = "успешно создан";
    ...
    $MESS['SOA_TEMPL_PAY_LINK'] = "Если окно с платежной информацией не открылось автоматически, нажмите на ссылку <a id=\"payMaster\" href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a>.";
    ...
    $MESS['SOA_TEMPL_DISKOUNT_IT'] = 'Сумма заказа:';
    $MESS['SOA_TEMPL_DISKOUNT_2_IT'] = 'Скидка:';
    $MESS['TITLE_ILI'] = 'ИЛИ';
?>