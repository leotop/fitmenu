        ...
        function PrintPropsForm($arSource = array(), $locationTemplate = ".default")
        {
            ...
            <div>
                <?
                    ...
                    {
                        if($arProperties["CODE"]=="FIO" || $arProperties["CODE"]=="PHONE" || $arProperties["CODE"]=="EMAIL" || $arProperties["CODE"]=="LOCATION"|| $arProperties["CODE"]=="PICKUP") {
                            ...
                            {
                            ?>
                            <?php if('ORDER_PROP_21' == $arProperties['FIELD_NAME'] ): ?>
                                <div class="i-w-text">
                                    <? endif ?>
                                <div class="i-text <? echo 'f_'.$arProperties['FIELD_NAME'] ?>">
                                    <!--<div class="bx_block r1x3 pt8 name">
                                        <?=$arProperties["NAME"]?>
                                        <?/*if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
                                            <span class="bx_sof_req">*</span>
                                        <?endif;*/?>
                                    ...
                                    <div class="bx_block r3x1 order-props__input">
                                        
                                        <input type="text" class="text-input" maxlength="250" <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?> placeholder="<?=$arProperties["NAME"]?>" <?endif;?> size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">
                                ...
                                <?php if('ORDER_PROP_24' == $arProperties['FIELD_NAME'] ): ?>
                                </div>
                                <? endif ?>
                            ...
                            ?>
                            <br/>
                            <div style="display: none;" class="bx_block r1x3 pt8">
                                <?=$arProperties["NAME"]?>
                                <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
                                    <span class="bx_sof_req">*</span>
                                    <?endif;?>
                            ...
                            <div style="display: none;" class="bx_block r3x1">
                            ...
                            ?>
                            <div class="bx_block r1x3 pt8 locationHidden">
                                <?=$arProperties["NAME"]?>
                                <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
                                    <span class="bx_sof_req">*</span>
                                    <?endif;?>
                            ...
                            <div class="bx_block r3x1 locationHidden" >
