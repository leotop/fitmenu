    ...
    $.fn.timeTo = function(){
        ...
        return this.each(function(){
            ...
            if(!data.vals){ // new clock
                ...
                data.height = Math.round(data.fontSize*100/93);
                data.width = Math.round(data.fontSize*.8 + data.height*.13 +10);
                ...
                var left = Math.round(data.height / 10),
                    ...
                    style = ' style="width:'+ data.width +'px; height:'+ (data.height + 15) +'px;"',
                    dhtml1 = '<div class="first"'+ style +'>'+ ulhtml,
                    dhtml2 = '<div'+ style +'>'+ ulhtml,
                    dot2 = '<span>:</span>',
                    /*maxWidth = Math.round(data.width * 2 + 3),*/
                    maxWidth = Math.round(data.width * 2 + 30),
                    captionSize = data.captionSize || Math.round(data.fontSize * 0.43);
                    thtml = (data.displayCaptions ?
                        (data.displayHours
                            ? '<figure class="t-hour" style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].hours +'</figcaption></figure>'+ dot2
                            : '') +
                        '<figure  class="t-day" style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].min +'</figcaption></figure>'+ dot2 +
                        '<figure  class="t-secound" style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].sec +'</figcaption></figure>'
                ...
                if(data.displayDays > 0){
                    ...
                    thtml = (data.displayCaptions ?
                        '<figure style="width:'+ Math.round(data.width*data.displayDays + marginRight + 15) +'px">$1<figcaption style="font-size:'+ captionSize +'px; padding-right:'+ Math.round(marginRight) +'px">'+ dictionary[data.lang].days +'</figcaption></figure>'
                        : '$1').replace(
                            /\$1/, dhtml
                        ) + thtml;
                }
