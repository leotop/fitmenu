...
<form method="post" action="<?='/login/?register=yes&backurl='.POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
<?
if($arResult["BACKURL"] <> ''):
?>
...
<table>
	<thead>
		<tr>
			<td colspan="2"><h2><?=GetMessage("AUTH_REGISTER")?></h2>
            <div class="gray">5 шагов займут не более 5 минут</div>
            </td>
		</tr>
	</thead>
	<tbody>
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input type="submit" name="register_submit_button" class="it-button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
