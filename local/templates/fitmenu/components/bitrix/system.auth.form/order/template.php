...
?>	<div class="login_page">
	...
	<?/*<h2>Войти в личный кабинет <? //echo GetMessage("AUTH_TITLE")?></h2>*/?>
	<?endif?>
	<?if($arResult["AUTH_SERVICES"]):
	...
	<form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=SITE_DIR?>auth/<?//=$arResult["AUTH_URL"]?>" class="bx_auth_form">
		...
		<?endif?>
		<input type="submit" name="Login" class="it-button" data-class="bt_blue big shadow" value="<?=GetMessage("AUTH_AUTHORIZE")?>" />
	</form>
</div>
