...
<div class="menu_inner">
    <span class="menu-open__title">Выбор по параметрам</span>
    <button class="menu__trigger" type="button">☰</button>
</div>
        ...
        <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
        {
          ...
          if (isset($arItem["PRICE"])):
            ...
            <div class="bx-filter-parameters-box">
              ...
              <div class="bx-filter-parameters-box-title"><span><?= $arItem["NAME"] ?> <i data-role="prop_angle"
                                                                                          class="fa fa-angle-down"></i></span>
              </div>
              <div class="bx-filter-block bx-filter-block__dropdown" data-role="bx_filter_block">
                <div class="bx-filter-block__close">x</div>
