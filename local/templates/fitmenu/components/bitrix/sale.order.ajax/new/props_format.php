...
if (!function_exists("PrintPropsForm"))
{
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default")
	{
		...
		foreach($arSource as $key => $arProperties){
			$arSort[$key] = $arProperties[SORT];
		}
		//print_r($arSort);
			?><pre><?//print_r($arSource)?></pre>
					<?
					foreach ($arSource as $arProperties)
					{
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
                            ...
                            <div class="i-w-text">
                            <? endif ?>
                            <div class="i-text <? echo 'f_'.$arProperties['FIELD_NAME'] ?> <?=$arProperties["CODE"]?>">
    							<div class="bx_block r1x3 pt8">
    								<?=$arProperties["NAME"]?>
    							</div>
    							...
    							<div class="bx_block r3x1">
    								...
    								<?endif;?>
    								 class="<?=$arProperties["FIELD_CODE"]?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">
						...
						elseif ($arProperties["TYPE"] == "SELECT")
						{
							...
							<div class="bx_block r3x1">
								<select name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" size="<?=$arProperties["SIZE1"]?>">*/?>
									...
									?>
										<label><input type="radio" name="<?=$arProperties["FIELD_NAME"]?>"  <?if ($arVariants["SELECTED"] == "Y") echo " selected";?> value="<?=$arVariants["VALUE"]?>"><?=$arVariants["NAME"]?></label><Br>
