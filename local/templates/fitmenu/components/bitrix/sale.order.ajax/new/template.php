...
<h1 class="order-title">Оформление заказа</h1>
	...
	if(!$USER->IsAuthorized() && $arParams["ALLOW_AUTO_REGISTER"] == "N")
	{
		...
		include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/auth.php");//авторизация
	}
	else
	{
		if($arResult["USER_VALS"]["CONFIRM_ORDER"] == "Y" || $arResult["NEED_REDIRECT"] == "Y")
...
<div class="third-step">
 ...
 <? if(!$USER->IsAuthorized()): ?>
            <div class="wrapper block-order" id="block_auth">
				...
				<!--<div class="note">
                        <h6>Преимущества регистрации</h6>
                        <div class="content">
<ul>
      <li>Накопление скидки до 10% на любой заказ
      <li>Отслеживание Ваших заказов on-line
     <li>Личный кабинет с историей покупок.
							</ul>
