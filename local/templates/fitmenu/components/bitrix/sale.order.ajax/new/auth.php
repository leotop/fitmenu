		...
		<td>
			<form method="post" action="" name="order_auth_form">
				...
				<table class="sale_order_full_table">
					<tr>
						<td nowrap>
							<input type="text" name="USER_LOGIN" maxlength="30" plaseholder="<?echo GetMessage("STOF_LOGIN")?>" size="30" value="<?=$arResult["AUTH"]["USER_LOGIN"]?>"></td>
					</tr>
					<tr>
						<td nowrap>
							<input type="password" plaseholder="<?echo GetMessage("STOF_PASSWORD")?>" name="USER_PASSWORD" maxlength="30" size="30"></td>
					</tr>
					<tr>
