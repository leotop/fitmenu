...
<div class="bx_ordercart">
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="bx_section">
			...
			<div class="bx_block w100"><textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" style="max-width:100%;min-height:80px"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea></div>
