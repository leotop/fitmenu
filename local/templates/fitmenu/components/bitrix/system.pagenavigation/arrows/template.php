...
?>
  ...
  <!-- -->
    <? if(! empty($arResult['pages_counter'])): ?>
        <div class="pager-counter">
            <div class="block">
                <div class="label"><?=GetMessage("counter_title")?></div>
                <form action="<? echo $arResult['sUrlPathParams'] ?>" method="GET">
                <div class="select">
                    <select name="page_count">
                    <? foreach($arResult['pages_counter'] as $c): ?>
                        <option value="<? echo $c ?>" <? echo ($arResult['current_page_counter'] == $c ? 'selected="selected"': '') ?> ><? echo $c ?></option>
                    <? endforeach ?>
                    </select>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    $(function(){
        $('.pager-counter select').change(function(){
