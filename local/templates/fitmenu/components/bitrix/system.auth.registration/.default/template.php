...
?>
	...
	<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform">
		...
		<span class="starrequired">*</span><?=GetMessage("AUTH_EMAIL")?><br />
		...
		<?if ($arResult["USE_CAPTCHA"] == "Y"):?>
			<b><?=GetMessage("CAPTCHA_REGF_TITLE")?></b><br />
