...
$this->SetViewTarget("catalog_mit");
...
<? if (!empty($arResult['ITEMS'])): ?>
	...
	<div class="bx_item_list_title h3"><? echo GetMessage('SRP_HREF_TITLE') ?>:</div>
	...
	<div class="<? echo($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"
		id="<? echo $strMainID; ?>">
	<div class="recommend__image bx_catalog_item_container <? echo $showImgClass; ?>">
