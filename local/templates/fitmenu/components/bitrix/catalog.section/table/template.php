...
<!--  TABLE -->
 <table class="table-category">
        <thead>
            <tr>
                <td class="th-photo"><?= GetMessage('TABLE_TH_PHOTO')?></td>
                <td class="th-name"><?= GetMessage('TABLE_TH_NAME')?></td>
                <td class="th-price"><?= GetMessage('TABLE_TH_PRICE')?></td>
                <td class="th-storage"><?= GetMessage('TABLE_TH_STORAGE')?></td>
                <td class="th-count"><?= GetMessage('TABLE_TH_COUNT')?></td>
                <td class="th-action">
                    <a href="" title="" class="it-button addall">Купить все отмеченное</a>
                </td>
            </tr>
        </thead>
        <tbody>
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?>
    <tr class="row-product" id="<? echo $strMainID; ?>">
      <td>  
          <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>" class="preview">
               <img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt="<? echo $arItem['PREVIEW_PICTURE']['ALT']; ?>" title="<? echo $arItem['PREVIEW_PICTURE']['TITLE']; ?>" />
          </a>          
            ...
            <!--contorls -->
                ...
                <td>
                     ...
                     <div class="bx_catalog_item_title">
                        <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>" class="name"><? echo $productTitle; ?></a>
                      </div>
                      <? if (isset($arItem['DISPLAY_PROPERTIES']) && !empty($arItem['DISPLAY_PROPERTIES'])) : ?>
                  			<div class="bx_catalog_item_articul">
                             <?	foreach ($arItem['DISPLAY_PROPERTIES'] as $arOneProp)  : ?>
                                <div class="prop_<? echo $arOneProp['CODE'] ?>">
                    			<span class="label"><? echo $arOneProp['NAME']; ?></span> <?
                    					echo (
                ...
                <td>
                    <!-- PRICE -->
                    <div class="bx_catalog_item_price"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price price">
                    <?
                    ...
                    <?
                    	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
                    	{
                    		...
                    		if ($arItem['CAN_BUY'])
                    		{
                    			...
                    			{
                    			?>
                    		<div class="bx_catalog_item_controls_blockone"><div class="counter" style="display: inline-block;position: relative;">
                    			<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small down" rel="nofollow"></a>
                                <div class="it-text">
                    			...
                    			<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small up" rel="nofollow"></a>
                ...
                <td class="actions">
                    <div class="it-checkbox">
                        <input type="checkbox" name="add[]" value="1" data-id="<? echo $arItem['ID']?>" class="addcheck" />
                    </div>
                    ...
                    <?	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) { ?>
                        <?	if ($arItem['CAN_BUY']) {
                                ...
                                <div class="bx_catalog_item_controls_blocktwo buttons">
                        			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button it-button addcart bx_medium" href="javascript:void(0)" rel="nofollow"><i></i><?
                        			echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY'));
                        			?></a>
                        		</div>
                                <? }
