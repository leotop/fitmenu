...
<div class="in_stock_filter">
    ...
    $arParams['HIDE_NOT_AVAILABLE'] = "Y"; // все в наличии
    ?>
...
if($arParams["HIDE_NOT_AVAILABLE"] == 'Y'){
    /*$arSubQuery = array(">CATALOG_QUANTITY" => "0");
    $sub = CIBlockElement::SubQuery('PROPERTY_CML2_LINK', $arSubQuery);
    $arrFilter['PROPERTY_CML2_LINK'] = $sub;
    print_r($sub);
    */
    //$arSubQuery = array(">CATALOG_QUANTITY" => "0");
...
if (\Bitrix\Main\ModuleManager::isModuleInstalled("sale"))
{
	...
	{
		?><?$APPLICATION->IncludeComponent("bitrix:sale.bestsellers", "light", array(
			"HIDE_NOT_AVAILABLE" => $arParams["HIDE_NOT_AVAILABLE"],
