...
?>
<div class="catalog-section bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>">
<table>
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
    ...
    <tr class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
