...
unset($useBrands);
?>
<h2 class="hTovar"><?= $arResult["NAME"] ?></h2>
<div class="wrapperblockUpak">
		<div class="blockUpak">
                ...
                <div class="price_section">
                    ...
                    <b> <? $_p_pack = $arResult['MIN_PRICE']['DISCOUNT_VALUE']/$COUNT_PACK; echo number_format($_p_pack,0,'.',' '); ?></b>
                    <span class="rub">&nbsp;Р</span>
                </div>
                    ...
                    ?>
                       ...
                       <div class="params">
                					<div class="w">
                                        ...
                                        <p class="bendLink">Порций в упаковке: <strong><? echo (! empty($arResult['PROPERTIES']['COUNT_PACK']['VALUE']) ? $arResult['PROPERTIES']['COUNT_PACK']['VALUE'] : ''); ?></strong></p>
                        					<div >
